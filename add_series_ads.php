...
if (isset($_POST["submit"])) {
    $db->exec("INSERT INTO series_ads(type, pages, images, text) VALUES('image', 'dashboard', '" . $_POST["images"] . "', 'bet3')");
    $db->close();
    header("Location: seriesads.php");
}
include "includes/header.php";
echo "\r<!-- [ Main Content ] start -->\r    <div class=\"pcoded-main-container\">\r        <div class=\"pcoded-wrapper\">\r            <div class=\"pcoded-content\">\r                <div class=\"pcoded-inner-content\">\r                    <div class=\"main-body\">\r                        <div class=\"page-wrapper\">\r                            <!-- [ Main Content ] start -->\r                            <div class=\"row\">\r                    <!-- Column -->\r                    <div class=\"col-lg-12\">\r                        <div class=\"card mb-4\">\r\t\t\t\t\t\t\t<div class=\"card-header bg-primary py-3\">\r                \t\t\t\t<h4 align=\"center\" class=\"m-0 font-weight-bold text-white\"><i class=\"fas fa-images\" style=\"font-size:20px\">&nbsp;&nbsp;</i>Upload AD Image</h4>\r                \t\t\t</div>\r                         <div class=\"card-body\">\r\t\t\t\t\t\t<form method=\"post\">\r                                <div class=\"form-group\">\r                                                                  </div>\r\t\t\t\t\t\t\t\t<div class=\"form-group\">\r                                    <label class=\"form-label \" for=\"images\"><strong>Image Url</strong></label>\r                                    <input class=\"form-control text-primary\" id=\"images\" name=\"images\" type=\"url\" required/>\r                                </div>\r\t\t\t\t\t\t\t    <div class=\"form-group\">\r\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"CreateDate\" value=\"";
